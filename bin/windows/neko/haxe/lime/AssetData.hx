...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			path.set ("graphics/block1.png", "graphics/block1.png");
			type.set ("graphics/block1.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("graphics/block2.png", "graphics/block2.png");
			type.set ("graphics/block2.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("graphics/magic.png", "graphics/magic.png");
			type.set ("graphics/magic.png", Reflect.field (AssetType, "image".toUpperCase ()));
