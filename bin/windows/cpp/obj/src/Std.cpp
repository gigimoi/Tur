...
bool Std_obj::is( Dynamic v,Dynamic t){
	HX_STACK_FRAME("Std","is",0x3c56d6f5,"Std.is","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Std.hx",24,0x9a964584)
	HX_STACK_ARG(v,"v")
	HX_STACK_ARG(t,"t")
	HX_STACK_LINE(24)
...
Dynamic Std_obj::instance( Dynamic value,::Class c){
	HX_STACK_FRAME("Std","instance",0x1431f4e0,"Std.instance","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Std.hx",28,0x9a964584)
...
::String Std_obj::string( Dynamic s){
	HX_STACK_FRAME("Std","string",0xcf48855c,"Std.string","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Std.hx",32,0x9a964584)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(32)
	if (((s == null()))){
		HX_STACK_LINE(32)
...
int Std_obj::_int( Float x){
	HX_STACK_FRAME("Std","int",0x8fa53b84,"Std.int","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Std.hx",36,0x9a964584)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(36)
	return ::__int__(x);
}
...
Dynamic Std_obj::parseInt( ::String x){
	HX_STACK_FRAME("Std","parseInt",0x90c2ebc7,"Std.parseInt","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Std.hx",40,0x9a964584)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(40)
...
Float Std_obj::parseFloat( ::String x){
	HX_STACK_FRAME("Std","parseFloat",0xbca10a74,"Std.parseFloat","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Std.hx",44,0x9a964584)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(44)
...
int Std_obj::random( int x){
	HX_STACK_FRAME("Std","random",0x75a77e8e,"Std.random","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Std.hx",47,0x9a964584)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(48)
	if (((x <= (int)0))){
		HX_STACK_LINE(48)
