...
{
		HX_STACK_FRAME("Sys","print",0x483745ec,"Sys.print","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",25,0x85815f5a)
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(25)
		::__hxcpp_print(v);
	}
...
{
		HX_STACK_FRAME("Sys","println",0x3905f76e,"Sys.println","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",28,0x85815f5a)
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(29)
		::Sys_obj::print(v);
		HX_STACK_LINE(30)
...
::haxe::io::Output Sys_obj::_stderr( ){
	HX_STACK_FRAME("Sys","stderr",0x3eb04003,"Sys.stderr","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",41,0x85815f5a)
	HX_STACK_LINE(42)
...
Array< ::String > Sys_obj::args( ){
	HX_STACK_FRAME("Sys","args",0xeaeddc7e,"Sys.args","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",50,0x85815f5a)
	HX_STACK_LINE(50)
	return ::__get_args();
}
...
{
		HX_STACK_FRAME("Sys","sleep",0xfe70aad6,"Sys.sleep","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",65,0x85815f5a)
...
{
		HX_STACK_FRAME("Sys","setCwd",0xa6272e0f,"Sys.setCwd","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",77,0x85815f5a)
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(77)
		::Sys_obj::set_cwd(s);
	}
...
{
		HX_STACK_FRAME("Sys","exit",0xed97463f,"Sys.exit","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",108,0x85815f5a)
...
::String Sys_obj::executablePath( ){
	HX_STACK_FRAME("Sys","executablePath",0xfc9406f0,"Sys.executablePath","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Sys.hx",119,0x85815f5a)
	HX_STACK_LINE(120)
