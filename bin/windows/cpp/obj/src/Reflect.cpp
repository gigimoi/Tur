...
bool Reflect_obj::hasField( Dynamic o,::String field){
	HX_STACK_FRAME("Reflect","hasField",0xef8c2571,"Reflect.hasField","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",25,0xaefd1eaa)
	HX_STACK_ARG(o,"o")
...
Dynamic Reflect_obj::field( Dynamic o,::String field){
	HX_STACK_FRAME("Reflect","field",0x54b04da9,"Reflect.field","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",29,0xaefd1eaa)
	HX_STACK_ARG(o,"o")
	HX_STACK_ARG(field,"field")
	HX_STACK_LINE(29)
	if (((o == null()))){
...
Dynamic Reflect_obj::callMethod( Dynamic o,Dynamic func,Dynamic args){
	HX_STACK_FRAME("Reflect","callMethod",0xb49e52d0,"Reflect.callMethod","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",46,0xaefd1eaa)
	HX_STACK_ARG(o,"o")
	HX_STACK_ARG(func,"func")
	HX_STACK_ARG(args,"args")
	struct _Function_1_1{
		inline static bool Block( Dynamic &func){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",47,0xaefd1eaa)
			{
				HX_STACK_LINE(47)
...
Array< ::String > Reflect_obj::fields( Dynamic o){
	HX_STACK_FRAME("Reflect","fields",0xc593a6aa,"Reflect.fields","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",53,0xaefd1eaa)
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(54)
	if (((o == null()))){
		HX_STACK_LINE(54)
...
bool Reflect_obj::isFunction( Dynamic f){
	HX_STACK_FRAME("Reflect","isFunction",0x0f1541d3,"Reflect.isFunction","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",61,0xaefd1eaa)
	HX_STACK_ARG(f,"f")
	HX_STACK_LINE(61)
	if (((f != null()))){
		HX_STACK_LINE(61)
...
bool Reflect_obj::compareMethods( Dynamic f1,Dynamic f2){
	HX_STACK_FRAME("Reflect","compareMethods",0x8b8ddd7e,"Reflect.compareMethods","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",68,0xaefd1eaa)
	HX_STACK_ARG(f1,"f1")
	HX_STACK_ARG(f2,"f2")
	HX_STACK_LINE(69)
	if (((f1 == f2))){
...
bool Reflect_obj::isObject( Dynamic v){
	HX_STACK_FRAME("Reflect","isObject",0xd04960ba,"Reflect.isObject","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",76,0xaefd1eaa)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(77)
	if (((v == null()))){
		HX_STACK_LINE(77)
...
bool Reflect_obj::deleteField( Dynamic o,::String field){
	HX_STACK_FRAME("Reflect","deleteField",0x21895ebe,"Reflect.deleteField","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",87,0xaefd1eaa)
	HX_STACK_ARG(o,"o")
	HX_STACK_ARG(field,"field")
	HX_STACK_LINE(88)
	if (((o == null()))){
...
Dynamic Reflect_obj::makeVarArgs( Dynamic f){
	HX_STACK_FRAME("Reflect","makeVarArgs",0x978955c5,"Reflect.makeVarArgs","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Reflect.hx",105,0xaefd1eaa)
	HX_STACK_ARG(f,"f")
	HX_STACK_LINE(105)
