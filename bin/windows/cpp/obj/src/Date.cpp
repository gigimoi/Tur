...
{
HX_STACK_FRAME("Date","new",0x9aa26240,"Date.new","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",26,0xfaf4b1a7)
HX_STACK_THIS(this)
...
Float Date_obj::getTime( ){
	HX_STACK_FRAME("Date","getTime",0x0cac7da3,"Date.getTime","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",31,0xfaf4b1a7)
	HX_STACK_THIS(this)
	HX_STACK_LINE(31)
...
::Date Date_obj::fromTime( Float t){
	HX_STACK_FRAME("Date","fromTime",0x44fd3cb7,"Date.fromTime","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",57,0xfaf4b1a7)
	HX_STACK_ARG(t,"t")
	HX_STACK_LINE(58)
...
::Date Date_obj::fromString( ::String s){
	HX_STACK_FRAME("Date","fromString",0x5ead97fb,"Date.fromString","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",63,0xfaf4b1a7)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(64)
	{
		HX_STACK_LINE(64)
