...
::Class Type_obj::getClass( Dynamic o){
	HX_STACK_FRAME("Type","getClass",0xc4e49bd6,"Type.getClass","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",35,0xdf42749b)
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(36)
...
::String Type_obj::getClassName( ::Class c){
	HX_STACK_FRAME("Type","getClassName",0x8e66dd41,"Type.getClassName","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",56,0xdf42749b)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(57)
	if (((c == null()))){
		HX_STACK_LINE(58)
...
::Class Type_obj::resolveClass( ::String name){
	HX_STACK_FRAME("Type","resolveClass",0x23b06bc0,"Type.resolveClass","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",66,0xdf42749b)
...
::Enum Type_obj::resolveEnum( ::String name){
	HX_STACK_FRAME("Type","resolveEnum",0x26394079,"Type.resolveEnum","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",73,0xdf42749b)
	HX_STACK_ARG(name,"name")
	HX_STACK_LINE(74)
	::Class result = ::Class_obj::Resolve(name);		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(75)
...
Dynamic Type_obj::createInstance( ::Class cl,Dynamic args){
	HX_STACK_FRAME("Type","createInstance",0xab84f9c5,"Type.createInstance","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",80,0xdf42749b)
	HX_STACK_ARG(cl,"cl")
...
Dynamic Type_obj::createEmptyInstance( ::Class cl){
	HX_STACK_FRAME("Type","createEmptyInstance",0xcb752312,"Type.createEmptyInstance","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",87,0xdf42749b)
	HX_STACK_ARG(cl,"cl")
	HX_STACK_LINE(87)
...
Dynamic Type_obj::createEnum( ::Enum e,::String constr,Dynamic params){
	HX_STACK_FRAME("Type","createEnum",0xd8d56d31,"Type.createEnum","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",91,0xdf42749b)
	HX_STACK_ARG(e,"e")
...
Dynamic Type_obj::createEnumIndex( ::Enum e,int index,Dynamic params){
	HX_STACK_FRAME("Type","createEnumIndex",0xd21e2c21,"Type.createEnumIndex","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",94,0xdf42749b)
	HX_STACK_ARG(e,"e")
...
Array< ::String > Type_obj::getInstanceFields( ::Class c){
	HX_STACK_FRAME("Type","getInstanceFields",0xe970f890,"Type.getInstanceFields","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",101,0xdf42749b)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(101)
...
Array< ::String > Type_obj::getClassFields( ::Class c){
	HX_STACK_FRAME("Type","getClassFields",0x7edf22ef,"Type.getClassFields","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",105,0xdf42749b)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(105)
...
Array< ::String > Type_obj::getEnumConstructs( ::Enum e){
	HX_STACK_FRAME("Type","getEnumConstructs",0x7f46cf7f,"Type.getEnumConstructs","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",109,0xdf42749b)
	HX_STACK_ARG(e,"e")
	HX_STACK_LINE(109)
...
bool Type_obj::enumEq( Dynamic a,Dynamic b){
	HX_STACK_FRAME("Type","enumEq",0x855650e1,"Type.enumEq","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Type.hx",129,0xdf42749b)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(129)
	return (a == b);
