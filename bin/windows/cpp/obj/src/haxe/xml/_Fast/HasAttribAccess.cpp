...
{
HX_STACK_FRAME("haxe.xml._Fast.HasAttribAccess","new",0x4d025ce8,"haxe.xml._Fast.HasAttribAccess.new","C:\\Programs\\HaxeToolkit\\haxe\\std/haxe/xml/Fast.hx",67,0x3fd04ed7)
HX_STACK_THIS(this)
HX_STACK_ARG(x,"x")
{
	HX_STACK_LINE(67)
...
bool HasAttribAccess_obj::resolve( ::String name){
	HX_STACK_FRAME("haxe.xml._Fast.HasAttribAccess","resolve",0x0ac38374,"haxe.xml._Fast.HasAttribAccess.resolve","C:\\Programs\\HaxeToolkit\\haxe\\std/haxe/xml/Fast.hx",70,0x3fd04ed7)
	HX_STACK_THIS(this)
