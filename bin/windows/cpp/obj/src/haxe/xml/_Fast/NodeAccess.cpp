...
{
HX_STACK_FRAME("haxe.xml._Fast.NodeAccess","new",0xde09fb0a,"haxe.xml._Fast.NodeAccess.new","C:\\Programs\\HaxeToolkit\\haxe\\std/haxe/xml/Fast.hx",29,0x3fd04ed7)
HX_STACK_THIS(this)
HX_STACK_ARG(x,"x")
{
	HX_STACK_LINE(29)
...
::haxe::xml::Fast NodeAccess_obj::resolve( ::String name){
	HX_STACK_FRAME("haxe.xml._Fast.NodeAccess","resolve",0x0e91da96,"haxe.xml._Fast.NodeAccess.resolve","C:\\Programs\\HaxeToolkit\\haxe\\std/haxe/xml/Fast.hx",32,0x3fd04ed7)
	HX_STACK_THIS(this)
