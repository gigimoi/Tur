...
{
HX_STACK_FRAME("haxe.xml._Fast.HasNodeAccess","new",0xd184aba0,"haxe.xml._Fast.HasNodeAccess.new","C:\\Programs\\HaxeToolkit\\haxe\\std/haxe/xml/Fast.hx",83,0x3fd04ed7)
HX_STACK_THIS(this)
HX_STACK_ARG(x,"x")
{
	HX_STACK_LINE(83)
...
bool HasNodeAccess_obj::resolve( ::String name){
	HX_STACK_FRAME("haxe.xml._Fast.HasNodeAccess","resolve",0x2b3f8e2c,"haxe.xml._Fast.HasNodeAccess.resolve","C:\\Programs\\HaxeToolkit\\haxe\\std/haxe/xml/Fast.hx",87,0x3fd04ed7)
	HX_STACK_THIS(this)
