...
{
HX_STACK_FRAME("haxe.xml._Fast.NodeListAccess","new",0x22c8c708,"haxe.xml._Fast.NodeListAccess.new","C:\\Programs\\HaxeToolkit\\haxe\\std/haxe/xml/Fast.hx",97,0x3fd04ed7)
HX_STACK_THIS(this)
HX_STACK_ARG(x,"x")
{
	HX_STACK_LINE(97)
...
::List NodeListAccess_obj::resolve( ::String name){
	HX_STACK_FRAME("haxe.xml._Fast.NodeListAccess","resolve",0x21d97d94,"haxe.xml._Fast.NodeListAccess.resolve","C:\\Programs\\HaxeToolkit\\haxe\\std/haxe/xml/Fast.hx",100,0x3fd04ed7)
	HX_STACK_THIS(this)
