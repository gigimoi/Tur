...
{
HX_STACK_FRAME("haxe.xml._Fast.AttribAccess","new",0x8109dad2,"haxe.xml._Fast.AttribAccess.new","C:\\Programs\\HaxeToolkit\\haxe\\std/haxe/xml/Fast.hx",48,0x3fd04ed7)
HX_STACK_THIS(this)
HX_STACK_ARG(x,"x")
{
	HX_STACK_LINE(48)
...
::String AttribAccess_obj::resolve( ::String name){
	HX_STACK_FRAME("haxe.xml._Fast.AttribAccess","resolve",0x20913e5e,"haxe.xml._Fast.AttribAccess.resolve","C:\\Programs\\HaxeToolkit\\haxe\\std/haxe/xml/Fast.hx",51,0x3fd04ed7)
	HX_STACK_THIS(this)
