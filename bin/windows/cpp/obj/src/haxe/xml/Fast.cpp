...
{
HX_STACK_FRAME("haxe.xml.Fast","new",0xda21546d,"haxe.xml.Fast.new","C:\\Programs\\HaxeToolkit\\haxe\\std/haxe/xml/Fast.hx",122,0x3fd04ed7)
HX_STACK_THIS(this)
HX_STACK_ARG(x,"x")
{
	HX_STACK_LINE(123)
...
::String Fast_obj::get_name( ){
	HX_STACK_FRAME("haxe.xml.Fast","get_name",0x9611daa7,"haxe.xml.Fast.get_name","C:\\Programs\\HaxeToolkit\\haxe\\std/haxe/xml/Fast.hx",134,0x3fd04ed7)
	HX_STACK_THIS(this)
	HX_STACK_LINE(134)
...
::String Fast_obj::get_innerData( ){
	HX_STACK_FRAME("haxe.xml.Fast","get_innerData",0x21ea0104,"haxe.xml.Fast.get_innerData","C:\\Programs\\HaxeToolkit\\haxe\\std/haxe/xml/Fast.hx",137,0x3fd04ed7)
	HX_STACK_THIS(this)
	HX_STACK_LINE(138)
	...
	if (((n != null()))){
		struct _Function_2_1{
			inline static bool Block( ::Xml &v){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\Programs\\HaxeToolkit\\haxe\\std/haxe/xml/Fast.hx",145,0x3fd04ed7)
				{
					HX_STACK_LINE(145)
		...
		if (((  (((bool((v->nodeType == ::Xml_obj::PCData)) && bool((n->nodeType == ::Xml_obj::CData))))) ? bool(_Function_2_1::Block(v)) : bool(false) ))){
			...
			struct _Function_3_1{
				inline static bool Block( Dynamic &it,::Xml &n2){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\Programs\\HaxeToolkit\\haxe\\std/haxe/xml/Fast.hx",147,0x3fd04ed7)
					{
