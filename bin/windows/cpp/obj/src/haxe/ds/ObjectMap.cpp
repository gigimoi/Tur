...
{
HX_STACK_FRAME("haxe.ds.ObjectMap","new",0x27af5498,"haxe.ds.ObjectMap.new","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",29,0x913b21a1)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(30)
...
{
		HX_STACK_FRAME("haxe.ds.ObjectMap","set",0x27b31fda,"haxe.ds.ObjectMap.set","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",34,0x913b21a1)
		HX_STACK_THIS(this)
...
Dynamic ObjectMap_obj::get( Dynamic key){
	HX_STACK_FRAME("haxe.ds.ObjectMap","get",0x27aa04ce,"haxe.ds.ObjectMap.get","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",40,0x913b21a1)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(41)
