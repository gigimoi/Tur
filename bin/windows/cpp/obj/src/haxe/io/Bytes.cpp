...
{
HX_STACK_FRAME("haxe.io.Bytes","new",0x3938d57d,"haxe.io.Bytes.new","C:\\Programs\\HaxeToolkit\\haxe\\std/haxe/io/Bytes.hx",33,0xffde96a9)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxe.io.Bytes","blit",0xd098ac78,"haxe.io.Bytes.blit","C:\\Programs\\HaxeToolkit\\haxe\\std/haxe/io/Bytes.hx",75,0xffde96a9)
		HX_STACK_THIS(this)
...
::haxe::io::Bytes Bytes_obj::sub( int pos,int len){
	HX_STACK_FRAME("haxe.io.Bytes","sub",0x393cae9d,"haxe.io.Bytes.sub","C:\\Programs\\HaxeToolkit\\haxe\\std/haxe/io/Bytes.hx",127,0xffde96a9)
	HX_STACK_THIS(this)
	HX_STACK_ARG(pos,"pos")
	HX_STACK_ARG(len,"len")
	HX_STACK_LINE(129)
...
::haxe::io::Bytes Bytes_obj::alloc( int length){
	HX_STACK_FRAME("haxe.io.Bytes","alloc",0x2199ead2,"haxe.io.Bytes.alloc","C:\\Programs\\HaxeToolkit\\haxe\\std/haxe/io/Bytes.hx",357,0xffde96a9)
	HX_STACK_ARG(length,"length")
	HX_STACK_LINE(367)
...
::haxe::io::Bytes Bytes_obj::ofString( ::String s){
	HX_STACK_FRAME("haxe.io.Bytes","ofString",0x6e53bb0b,"haxe.io.Bytes.ofString","C:\\Programs\\HaxeToolkit\\haxe\\std/haxe/io/Bytes.hx",382,0xffde96a9)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(393)
	Array< unsigned char > a = Array_obj< unsigned char >::__new();		HX_STACK_VAR(a,"a");
	HX_STACK_LINE(394)
...
::haxe::io::Bytes Bytes_obj::ofData( Array< unsigned char > b){
	HX_STACK_FRAME("haxe.io.Bytes","ofData",0x4f3005e4,"haxe.io.Bytes.ofData","C:\\Programs\\HaxeToolkit\\haxe\\std/haxe/io/Bytes.hx",445,0xffde96a9)
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(445)
