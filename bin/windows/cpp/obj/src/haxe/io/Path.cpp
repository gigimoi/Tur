...
{
HX_STACK_FRAME("haxe.io.Path","new",0x1b96d677,"haxe.io.Path.new","C:\\Programs\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",76,0x7ce04b83)
HX_STACK_THIS(this)
...
::String Path_obj::directory( ::String path){
	HX_STACK_FRAME("haxe.io.Path","directory",0xbcfe23c4,"haxe.io.Path.directory","C:\\Programs\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",141,0x7ce04b83)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(142)
