...
{
HX_STACK_FRAME("cpp.vm.Thread","new",0x66262c28,"cpp.vm.Thread.new","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/vm/Thread.hx",31,0xb8061d1e)
HX_STACK_THIS(this)
HX_STACK_ARG(h,"h")
{
	HX_STACK_LINE(31)
...
::cpp::vm::Thread Thread_obj::current( ){
	HX_STACK_FRAME("cpp.vm.Thread","current",0x21a37c01,"cpp.vm.Thread.current","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/vm/Thread.hx",45,0xb8061d1e)
	HX_STACK_LINE(46)
...
::cpp::vm::Thread Thread_obj::create( Dynamic callb){
	HX_STACK_FRAME("cpp.vm.Thread","create",0xb01a9834,"cpp.vm.Thread.create","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/vm/Thread.hx",52,0xb8061d1e)
