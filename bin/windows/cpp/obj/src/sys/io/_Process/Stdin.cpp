...
{
HX_STACK_FRAME("sys.io._Process.Stdin","new",0xd3131563,"sys.io._Process.Stdin.new","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/Process.hx",29,0x8cd6060d)
HX_STACK_THIS(this)
HX_STACK_ARG(p,"p")
{
	HX_STACK_LINE(30)
...
{
		HX_STACK_FRAME("sys.io._Process.Stdin","writeByte",0xfb987cca,"sys.io._Process.Stdin.writeByte","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/Process.hx",39,0x8cd6060d)
		HX_STACK_THIS(this)
		HX_STACK_ARG(c,"c")
		HX_STACK_LINE(40)
		this->buf->b[(int)0] = c;
...
int Stdin_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
	HX_STACK_FRAME("sys.io._Process.Stdin","writeBytes",0x29d4b469,"sys.io._Process.Stdin.writeBytes","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/Process.hx",44,0x8cd6060d)
	HX_STACK_THIS(this)
