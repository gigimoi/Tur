...
Dynamic FileSystem_obj::stat( ::String path){
	HX_STACK_FRAME("sys.FileSystem","stat",0xa630df16,"sys.FileSystem.stat","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",42,0x29fedc68)
	...
	if (((s == null()))){
		...
		struct _Function_2_1{
			inline static Dynamic Block( ::Date &_g1,::Date &_g,::Date &_g2){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",45,0x29fedc68)
				{
...
::String FileSystem_obj::fullPath( ::String relPath){
	HX_STACK_FRAME("sys.FileSystem","fullPath",0xc6463316,"sys.FileSystem.fullPath","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/sys/FileSystem.hx",52,0x29fedc68)
