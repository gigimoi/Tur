...
{
HX_STACK_FRAME("Xml","new",0x2e496e29,"Xml.new","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Xml.hx",41,0x97dab8d0)
HX_STACK_THIS(this)
{
}
;
...
HX_STACK_FRAME("Xml","__init__",0xbec8a6e7,"Xml.__init__","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Xml.hx",403,0x97dab8d0)
{
	HX_STACK_LINE(404)
...
::String Xml_obj::get( ::String att){
	HX_STACK_FRAME("Xml","get",0x2e441e5f,"Xml.get","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Xml.hx",197,0x97dab8d0)
	HX_STACK_THIS(this)
...
bool Xml_obj::exists( ::String att){
	HX_STACK_FRAME("Xml","exists",0x446683b3,"Xml.exists","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Xml.hx",219,0x97dab8d0)
	HX_STACK_THIS(this)
	HX_STACK_ARG(att,"att")
	HX_STACK_LINE(220)
	if (((this->nodeType != ::Xml_obj::Element))){
...
Dynamic Xml_obj::elements( ){
	HX_STACK_FRAME("Xml","elements",0x0310ffce,"Xml.elements","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Xml.hx",238,0x97dab8d0)
	HX_STACK_THIS(this)
	HX_STACK_LINE(239)
	...
	struct _Function_1_1{
		inline static Dynamic Block( Array< ::Dynamic > &children){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Xml.hx",242,0x97dab8d0)
			{
				...
				bool run(){
					HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Xml.hx",244,0x97dab8d0)
				...
				::Xml run(){
					HX_STACK_FRAME("*","_Function_2_2",0x5201af79,"*._Function_2_2","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Xml.hx",255,0x97dab8d0)
					HX_STACK_THIS(__this.mPtr)
					{
						HX_STACK_LINE(256)
						int k = __this->__Field(HX_CSTRING("cur"),true);		HX_STACK_VAR(k,"k");
...
::Xml Xml_obj::firstElement( ){
	HX_STACK_FRAME("Xml","firstElement",0xc103a583,"Xml.firstElement","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Xml.hx",311,0x97dab8d0)
	HX_STACK_THIS(this)
	HX_STACK_LINE(312)
	if (((this->_children == null()))){
		HX_STACK_LINE(313)
...
{
		HX_STACK_FRAME("Xml","addChild",0x3e639952,"Xml.addChild","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Xml.hx",322,0x97dab8d0)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(323)
		if (((this->_children == null()))){
...
::Xml Xml_obj::parse( ::String str){
	HX_STACK_FRAME("Xml","parse",0x8a44f23c,"Xml.parse","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Xml.hx",46,0x97dab8d0)
	...
	struct _Function_1_1{
		inline static Dynamic Block( ::Xml &x){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Xml.hx",49,0x97dab8d0)
			{
				hx::Anon __result = hx::Anon_obj::Create();
				...
				Void run(::String name,Dynamic att){
					HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Xml.hx",51,0x97dab8d0)
					HX_STACK_THIS(__this.mPtr)
				...
				Void run(::String text){
					HX_STACK_FRAME("*","_Function_2_2",0x5201af79,"*._Function_2_2","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Xml.hx",64,0x97dab8d0)
					HX_STACK_THIS(__this.mPtr)
				...
				Void run(::String text){
					HX_STACK_FRAME("*","_Function_2_3",0x5201af7a,"*._Function_2_3","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Xml.hx",71,0x97dab8d0)
					HX_STACK_THIS(__this.mPtr)
					HX_STACK_ARG(text,"text")
					{
						HX_STACK_LINE(72)
				...
				Void run(::String text){
					HX_STACK_FRAME("*","_Function_2_4",0x5201af7b,"*._Function_2_4","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Xml.hx",78,0x97dab8d0)
					HX_STACK_THIS(__this.mPtr)
					HX_STACK_ARG(text,"text")
					{
						HX_STACK_LINE(79)
				...
				Void run(::String text){
					HX_STACK_FRAME("*","_Function_2_5",0x5201af7c,"*._Function_2_5","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Xml.hx",92,0x97dab8d0)
					HX_STACK_THIS(__this.mPtr)
					HX_STACK_ARG(text,"text")
					{
						HX_STACK_LINE(93)
				...
				Void run(){
					HX_STACK_FRAME("*","_Function_2_6",0x5201af7d,"*._Function_2_6","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/Xml.hx",101,0x97dab8d0)
					HX_STACK_THIS(__this.mPtr)
					{
						HX_STACK_LINE(101)
