...
{
HX_STACK_FRAME("List","new",0xed890070,"List.new","C:\\Programs\\HaxeToolkit\\haxe\\std/List.hx",41,0x8ce70c4a)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(41)
	this->length = (int)0;
...
{
		HX_STACK_FRAME("List","add",0xed7f2231,"List.add","C:\\Programs\\HaxeToolkit\\haxe\\std/List.hx",49,0x8ce70c4a)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("List","push",0xebb5efca,"List.push","C:\\Programs\\HaxeToolkit\\haxe\\std/List.hx",64,0x8ce70c4a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(item,"item")
		HX_STACK_LINE(68)
...
Dynamic List_obj::first( ){
	HX_STACK_FRAME("List","first",0x898acc40,"List.first","C:\\Programs\\HaxeToolkit\\haxe\\std/List.hx",82,0x8ce70c4a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(82)
	if (((this->h == null()))){
		HX_STACK_LINE(82)
...
Dynamic List_obj::last( ){
	HX_STACK_FRAME("List","last",0xe901e846,"List.last","C:\\Programs\\HaxeToolkit\\haxe\\std/List.hx",91,0x8ce70c4a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(91)
	if (((this->q == null()))){
		HX_STACK_LINE(91)
...
Dynamic List_obj::pop( ){
	HX_STACK_FRAME("List","pop",0xed8a8da1,"List.pop","C:\\Programs\\HaxeToolkit\\haxe\\std/List.hx",100,0x8ce70c4a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(101)
	if (((this->h == null()))){
		HX_STACK_LINE(102)
...
bool List_obj::isEmpty( ){
	HX_STACK_FRAME("List","isEmpty",0xaa565653,"List.isEmpty","C:\\Programs\\HaxeToolkit\\haxe\\std/List.hx",115,0x8ce70c4a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(115)
	return (this->h == null());
}
...
bool List_obj::remove( Dynamic v){
	HX_STACK_FRAME("List","remove",0x4b44d634,"List.remove","C:\\Programs\\HaxeToolkit\\haxe\\std/List.hx",138,0x8ce70c4a)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(139)
...
Dynamic List_obj::iterator( ){
	HX_STACK_FRAME("List","iterator",0x2d4cdfde,"List.iterator","C:\\Programs\\HaxeToolkit\\haxe\\std/List.hx",179,0x8ce70c4a)
	HX_STACK_THIS(this)
	struct _Function_1_1{
		inline static Dynamic Block( hx::ObjectPtr< ::List_obj > __this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","C:\\Programs\\HaxeToolkit\\haxe\\std/List.hx",179,0x8ce70c4a)
			{
				...
				Dynamic run(){
					HX_STACK_FRAME("*","_Function_2_1",0x5201af78,"*._Function_2_1","C:\\Programs\\HaxeToolkit\\haxe\\std/List.hx",182,0x8ce70c4a)
				...
				Dynamic run(){
					HX_STACK_FRAME("*","_Function_2_2",0x5201af79,"*._Function_2_2","C:\\Programs\\HaxeToolkit\\haxe\\std/List.hx",185,0x8ce70c4a)
					HX_STACK_THIS(__this.mPtr)
					{
						HX_STACK_LINE(186)
