...
{
HX_STACK_FRAME("EReg","new",0x8b859e81,"EReg.new","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/EReg.hx",28,0x837f7886)
HX_STACK_THIS(this)
HX_STACK_ARG(r,"r")
...
bool EReg_obj::match( ::String s){
	HX_STACK_FRAME("EReg","match",0x18fda1a6,"EReg.match","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/EReg.hx",36,0x837f7886)
	HX_STACK_THIS(this)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(37)
...
::String EReg_obj::matched( int n){
	HX_STACK_FRAME("EReg","matched",0x8ce62f85,"EReg.matched","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/EReg.hx",45,0x837f7886)
	HX_STACK_THIS(this)
	HX_STACK_ARG(n,"n")
	HX_STACK_LINE(46)
...
Dynamic EReg_obj::matchedPos( ){
	HX_STACK_FRAME("EReg","matchedPos",0x7007a70f,"EReg.matchedPos","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/EReg.hx",62,0x837f7886)
	HX_STACK_THIS(this)
	HX_STACK_LINE(62)
...
::String EReg_obj::replace( ::String s,::String by){
	HX_STACK_FRAME("EReg","replace",0xae923ad5,"EReg.replace","C:\\Programs\\HaxeToolkit\\haxe\\std/cpp/_std/EReg.hx",98,0x837f7886)
	HX_STACK_THIS(this)
	HX_STACK_ARG(s,"s")
	HX_STACK_ARG(by,"by")
	HX_STACK_LINE(99)
