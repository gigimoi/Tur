...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(22)
		::openfl::_v2::Lib_obj::setPackage(HX_CSTRING(""),HX_CSTRING("Main2"),HX_CSTRING("net.gigimoi.tur"),HX_CSTRING("1.0.0"));
		...
		HX_STACK_LINE(38)
		::openfl::_v2::Lib_obj::create( Dynamic(new _Function_1_1()),(int)800,(int)600,(int)60,(int)0,(int((int((int((int((int((int((int((int((int((int(::openfl::_v2::Lib_obj::HARDWARE) | int(::openfl::_v2::Lib_obj::ALLOW_SHADERS))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::openfl::_v2::Lib_obj::VSYNC))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("HXPTest"),null(),null());
	}
return null();
}
