...
::String StringTools_obj::urlEncode( ::String s){
	HX_STACK_FRAME("StringTools","urlEncode",0x06afdce1,"StringTools.urlEncode","C:\\Programs\\HaxeToolkit\\haxe\\std/StringTools.hx",46,0x7409938a)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(46)
...
::String StringTools_obj::urlDecode( ::String s){
	HX_STACK_FRAME("StringTools","urlDecode",0x71b947f9,"StringTools.urlDecode","C:\\Programs\\HaxeToolkit\\haxe\\std/StringTools.hx",71,0x7409938a)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(71)
...
bool StringTools_obj::startsWith( ::String s,::String start){
	HX_STACK_FRAME("StringTools","startsWith",0x5f4e6efb,"StringTools.startsWith","C:\\Programs\\HaxeToolkit\\haxe\\std/StringTools.hx",133,0x7409938a)
	HX_STACK_ARG(s,"s")
...
::String StringTools_obj::replace( ::String s,::String sub,::String by){
	HX_STACK_FRAME("StringTools","replace",0x6d651f30,"StringTools.replace","C:\\Programs\\HaxeToolkit\\haxe\\std/StringTools.hx",303,0x7409938a)
	HX_STACK_ARG(s,"s")
