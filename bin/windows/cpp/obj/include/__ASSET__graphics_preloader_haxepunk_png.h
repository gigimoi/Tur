...
class HXCPP_CLASS_ATTRIBUTES  __ASSET__graphics_preloader_haxepunk_png_obj : public ::openfl::_v2::display::BitmapData_obj{
	public:
	...
	public:
		...
		::String __ToString() const { return HX_CSTRING("__ASSET__graphics_preloader_haxepunk_png"); }
